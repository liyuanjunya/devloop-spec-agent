# Feature Specification: LLM image-to-recipe: hardened POST /api/recipes/create/image (case-6 v1, 5-axis)
...
_Generated by DevLoop spec phase — writer=case6-live-new-20260620-v1, reviewer=case6-live-new-20260620-v1, iterations=1_